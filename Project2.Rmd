...
#### Second Analysis  
##### Linear Model  
Additional work added by QiaoZhi Bao, as part of post-Project 2 follow-up practice with GitHub forking a repo, making changes, then adding them as a pull request for the repo owner to review and merge into their original work.  
```{r, cache=TRUE}
